...
urlpatterns=[
    ...
    # online reservation
    path('create-reservation-list', views.OnlineReservationView.as_view(), name="create-reservation-list"),
    path('reservation-list', views.OnlineReservationListView.as_view(), name="all-reservation-list"),
]